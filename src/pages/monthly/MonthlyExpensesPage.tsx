...
import { loadAllData, saveMonthlyExpenses, saveMonthlyIncomes } from '@/shared/lib';
import { Expense, IncomeEntry } from '@/shared/types';
...
export function MonthlyExpensesPage({ userId }: Props) {

...
export function GroupHeader({ groupName, remaining, currentMonth, onMonthClick, onBack, onSettings }: Props) {
  return (
    <Paper
      sx={{
        p: 2,
    ...
    >
      ...
      <IconButton size="small" onClick={onSettings} sx={{ position: 'absolute', top: 8, right: 8 }}>
        <SettingsIcon />
      </IconButton>
